...
{ 
  ...
  if( offsetInTile == 0 ) {
    for( int t=0;t<tiles;++t) {
      char* dst = (char*)dest + startByte; //&rowTiles[0];
    ...
    for( int t=0;t<tiles;++t) {
      ...
      if(  t == tiles-1 && lastTilePixel <= 1 ) {
        ...
        *(dstPtr  + 28) = *(srcPtr + 28);
        ...
        //offsetInTile of <=1 and last pixel <=3 has no real problem with (char*)destination 
        char* dstPtr = dst+offsetInTile;
        char* srcPtr = src;
        *(dstPtr) =  *(srcPtr);
        *(dstPtr  + 4) =  *(srcPtr + 4);
        ...
        *(dstPtr  + 28) = *(srcPtr + 28);
        ...
        //offsetInTile of <=1 and last pixel <=5 has no real problem with (char*)destination 
        char* dstPtr = dst+offsetInTile;
        char* srcPtr = src;
        *(dstPtr) =  *(srcPtr);
        *(dstPtr  + 4) =  *(srcPtr + 4);
